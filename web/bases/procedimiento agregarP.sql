...
delimiter //
 create procedure addPerro(IdPerr int(3), Nom varchar(30), Pes float(5), Color varchar(10), Tam varchar(10), Edad varchar(20),Descrip blob, idCen int(2))
 begin 
	declare xIdPerr int;
    ...
    if (idPerr	 = 0) then
        ...
        if (existe = 0) then
            ...
            insert into Perro (IdPerro, Nombre, Peso, Color, Tamano ,Rango_edad ,Descripcion ,IdCentro) values(xIdPerr, Nom,  Pes , Color , Tam , Edad ,Descrip , idCen );
